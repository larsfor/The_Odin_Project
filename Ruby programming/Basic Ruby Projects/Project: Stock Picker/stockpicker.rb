...
def stock_picker(array)
  ...
  array.each_with_index do |_day, day_index|
    array.each_with_index do |_profit, profit_index|
      # You have to have bought before you can sell
      if profit_index > day_index && (array[profit_index] - array[day_index] > result)
