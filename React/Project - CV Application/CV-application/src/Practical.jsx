...
const initialPracItems = [ 
  { id: 0, company: 'Norsk Filmforbund', position: 'Økonomiansvarlig', respons: 'Fikse økonomien', dateStart: '2016-03-01', dateEnd: '2018-07-31' },
  { id: 1, company: 'View Ledger AS', position: 'Økonomikonsulent', respons: 'Masse tekst som en test for å sjekke hvorvidt layouten klarer å takle mer enn en setning.', dateStart: '2016-08-01', dateEnd: '2020-12-31' }
